// lib/core/infrastructure/services/permissions/handlers/battery_handler.dart
...
class BatteryOptimizationHandler extends PermissionHandlerBase {
  @override
  handler.Permission? get nativePermission => 
      Platform.isAndroid ? handler.Permission.ignoreBatteryOptimizations : null;
  
  @override
  AppPermissionType get permissionType => AppPermissionType.batteryOptimization;
